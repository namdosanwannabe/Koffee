...
const CartItem = ({ product }) => {
    ...
    return (
        <div className='p-3 flex justify-between items-center bg-white hover:bg-gray-100 transition-all duration-300 ease-out rounded'>
            ...
            <div className='flex gap-10 items-center'>
                ...
                <p className='font-bold text-lg text-black leading-relaxed'>{`${product?.total}`}</p>
